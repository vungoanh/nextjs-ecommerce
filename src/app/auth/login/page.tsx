            ...
            <div className='p-6 space-y-4 md:space-y-6 sm:p-8'>
              ...
              <Form onSubmit={handleSubmit} className='space-y-4 md:space-y-6' action='#'>
                ...
                <div className='flex items-center justify-between'>
                  ...
                  <Link href='/auth/reset' className='text-sm font-medium text-orange-600 hover:underline '>Forgot
                    password?</Link>
                </div>
                {
                  loading ? <button type='button'
                    ...
                    />
                                      ...
                                      className='w-full text-white bg-orange-600 da hover:bg-orange-700 focus:ring-4 focus:outline-none focus:ring-orange-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-orange-600 dark:hover:bg-orange-700 dark:focus:ring-orange-800'>Sign
                    in</button>
                }

                <p className='text-sm text-black '>
                  Don’t have an account yet? <Link href={'/auth/register'}
                                                   className='font-medium text-orange-600 hover:underline '>Sign
                  up</Link>
                </p>
              </Form>
            </div>
