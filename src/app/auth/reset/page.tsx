        ...
        <div className='flex flex-col items-center justify-center px-6 py-8 mx-auto h-screen lg:py-0'>
          <div className='w-full p-6 bg-white rounded-lg shadow  md:mt-0 sm:max-w-md  sm:p-8'>
            ...
            <Form onSubmit={handleSubmit} className='mt-4 space-y-4 lg:mt-5 md:space-y-5'>
              ...
              <div className='text-left'>
                <label htmlFor='confirm-password' className='block mb-2 text-sm font-medium text-gray-900 '>Confirm
                  password</label>
              ...
              </div>
              {
                loading ? <button type='button'
                  ...
                  />
                                    ...
                                    className='w-full text-white bg-orange-600 hover:bg-orange-700 focus:ring-4 focus:outline-none focus:ring-orange-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-orange-600 dark:hover:bg-orange-700 dark:focus:ring-orange-800'>Reset</button>
              }
