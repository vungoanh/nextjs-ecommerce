...
export default function Register() {
  ...
  const [isHiddenPass, setIsShowPassword] = useState<boolean>(true)
  ...
  return (
    <>
      ...
      <div className='w-full h-screen bg-gray-50 '>
        <div
          className='flex flex-col text-center items-center justify-center px-6 py-8 mx-auto h-screen lg:py-0 shadow-xl'>
            ...
            <div className='p-6 space-y-4 md:space-y-6 sm:p-8'>
              ...
              <Form onSubmit={handleSubmit} className='space-y-4 md:space-y-6' action='#'>
                <div className='text-left'>
                  ...
                  <Input onChange={(e) => setFormData({ ...formData, name: e.target.value })} type='text' name='name'
                         id='namw'
                  ...
                  <Input onChange={(e) => setFormData({ ...formData, password: e.target.value })}
                         ...
                         suffix={
                           isHiddenPass ? (
                             <EyeSlash
                               size='24'
                               onClick={() => setIsShowPassword(!isHiddenPass)}
                               className={'cursor-pointer text-neutral-tints duration-200 hover:text-primary'}
                             />
                           ) : (
                             <Eye
                               size='24'
...

                {
                  loading ? <button type='button'
                    ...
                    />
                                      ...
                                      className='w-full text-white bg-orange-600 hover:bg-orange-700 focus:ring-4 focus:outline-none focus:ring-orange-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center'>Sign
                    up</button>
                }
                ...
                <p className='text-sm  text-gray-500 '>
                  Already have an account <Link href='/auth/login'
                                                className='font-medium text-orange-600 hover:underline '>Sign In</Link>
                </p>
              </Form>
            </div>
          </div>
