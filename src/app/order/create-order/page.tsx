...
import { setCart } from '@/utils/cart-slice'
          ...
          <div className='w-full  h-full flex-col md:flex-row flex items-start justify-center'>
            ...
            <div className='md:w-2/3 w-full px-2 h-full flex-col items-end justify-end flex'>
              ...
              <div className='w-full  py-2 my-2 flex justify-end '>
                <h1
                  className='py-2 tracking-widest mb-2  border-b px-6 border-orange-600 text-sm  flex flex-col '> Original
                  Price <span className='text-xl font-extrabold'>Rs {totalPrice || 0}</span></h1>
                <h1
                  className='py-2 tracking-widest mb-2  border-b px-6 border-orange-600 text-sm  flex flex-col '> Shipping
                  Price <span className='text-xl font-extrabold'>Rs {500}</span></h1>
                <h1 className='py-2 tracking-widest mb-2  border-b px-6 border-orange-600 text-sm  flex flex-col '> tax
                  Price <span className='text-xl font-extrabold'>Rs {100}</span></h1>
              </div>
              <div className='w-full  py-2 my-2 flex justify-end '>
                <h1
                  className='py-2 tracking-widest mb-2  border-b px-6 border-orange-600 text-sm  flex flex-col '> Total
                  Order Price <span className='text-xl font-extrabold'>Rs {totalPrice + 600}</span></h1>
              </div>
            </div>
            ...
            <form onSubmit={handleSubmit(onSubmit)} className='md:w-1/3 px-2 w-full max-w-lg  py-2 flex-col '>
              <div className='form-control w-full mb-2'>
                ...
                <input {...register('fullName', { required: true })} type='text' placeholder='Type here'
              ...
              <div className='form-control w-full mb-2'>
                ...
                <input  {...register('address', { required: true })} type='text' placeholder='Type here'
                        className='input input-bordered w-full' />
              ...
              <div className='form-control w-full '>
                ...
                <input  {...register('postalCode', { required: true })} type='number'
                        className='file-input file-input-bordered w-full ' />
