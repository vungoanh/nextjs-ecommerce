...
export default function StatsTiles({ Icon, title, count }: Props) {
  return (
    <div
      className='w-96 h-40 m-2 dark:text-black cursor-pointer hover:shadow-xl transition-all duration-500 bg-white rounded flex flex-col items-center justify-center'>
