...

          {
            user ?
              <div className='flex items-center justify-center  min-h-full'>
                ...
                <button onClick={() => router.push('/order/create-order')} className='btn btn-circle  mx-2'>
                  <FaCartArrowDown className='text-white text-xl' /></button>
                <button onClick={() => router.push('/bookmark')} className='btn btn-circle  mx-2'><MdFavorite
                  className='text-white text-xl' /></button>
                <button onClick={() => router.push('/order/view-orders')} className='btn btn-circle  mx-2'>
                  <CiDeliveryTruck className='text-white text-xl' /></button>
