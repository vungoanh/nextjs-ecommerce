  ...
  return (
    <div className='w-full h-screen relative'>
      ...
      <div className='w-full flex-col md:hidden h-full relative flex items-center px-3 justify-center text-center'>
        ...
        <h1 className='mb-2 text-xl text-white/90 z-10 font-semibold '>Work hard, lift harder - Get fit, feel fitter
          with our gear!</h1>
        <Link href={'/#my-Categories'}
              className='btn btn-ghost border border-orange-600 text-white/90 hover:bg-orange-600  z-40'>Shop Now</Link>
